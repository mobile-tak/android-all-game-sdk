...
import com.tvtoday.gamelibrary.shabdjaalgamesdk.shabdviews.activities.leader_board_activity.LeaderBoardDataList

class LeaderBoardResultShabdAdapter(
    private val activity: Activity, private val list: ArrayList<LeaderBoardDataList>
) : RecyclerView.Adapter<LeaderBoardResultShabdAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val item = LayoutInflater.from(parent.context)
            .inflate(R.layout.leader_board_shabd_inner_layout, parent, false)
